...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Krishna Teja", "localhost",
			"bhogarajukrishnateja@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Rest Web Services Api Documentation",
